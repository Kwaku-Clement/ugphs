...
class AddForum extends StatefulWidget {
  ...
  const AddForum({Key key, this.id}) : super(key: key);
  @override
...
class _AddForumState extends State<AddForum> {
          ...
          child: Padding(
            ...
            child: Column(
              children: <Widget>[
                ...
                Container(
                  child: TextFormField(
                    initialValue: _currentModel.name,
                    keyboardType: TextInputType.text,
                    decoration:
                        kInputTextFieldDecoration.copyWith(labelText: 'Header'),
                ...
                Container(
                  ...
                  validator: (String value) {
                    if (value.isEmpty) {
                      return 'Forum detail is required';
                    }
  ...
  _saveFood() {
    ...
    Database(uid: user.uid)
        .uploadForumAndImage(_currentModel, _imageFile, _onForumUploaded);
  }

  _onForumUploaded(Question forum) {
    ModelNotifier modelNotifier =
        Provider.of<ModelNotifier>(context, listen: false);
    modelNotifier.addModel(forum);
